...
<div class="container mx-auto px-4 py-12">
    <div class="bg-white p-8 rounded-xl shadow-lg">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Ingeschreven Studenten</h1>
            <a href="{{ route('students.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-200">
                Nieuwe Student
            </a>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 student-row">
                                ...
                                <td class="px-4 py-3 text-sm text-gray-900">
                                    <div class="flex justify-center space-x-3">
                                        <a href="{{ route('students.show', $student) }}" class="text-blue-600 hover:text-blue-800 p-2 rounded-lg transition duration-200 flex items-center">
                                        ...
                                        <a href="{{ route('students.edit', $student) }}" class="text-yellow-600 hover:text-yellow-800 p-2 rounded-lg transition duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </a>
                                        <form action="{{ route('students.destroy', $student) }}" method="POST" class="inline" onsubmit="return confirm('Weet je zeker dat je deze student wilt verwijderen?');">
                                            @csrf
                                            @method('DELETE')
        ...
        @else
            <div class="bg-blue-50 rounded-lg p-6 text-center">
                ...
                <a href="{{ route('students.create') }}" class="mt-4 inline-block bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-200">
