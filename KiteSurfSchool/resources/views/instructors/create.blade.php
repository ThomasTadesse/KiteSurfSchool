        ...
        <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <form method="POST" action="{{ route('instructors.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input id="specialization" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('specialization') border-red-500 @enderror" name="specialization" value="{{ old('specialization') }}" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="bio" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('bio') border-red-500 @enderror" name="bio" rows="4">{{ old('bio') }}</textarea>
                    @error('bio')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input id="certifications" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('certifications') border-red-500 @enderror" name="certifications" value="{{ old('certifications') }}">
                ...
                <div class="mb-6">
                    ...
                    <input id="years_of_experience" type="number" min="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('years_of_experience') border-red-500 @enderror" name="years_of_experience" value="{{ old('years_of_experience') }}">
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('instructors.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">{{ __('Cancel') }}</a>
